...
| [0017](./adr/0017-console-certificate-management.md) | Installing a console certificate from the console — **Proposed** |
| [0018](./adr/0018-custom-roles.md) | Custom roles with granular permissions — **Proposed** |
